...
angular.module("bahmni.registration").controller("CreatePatientController", [
  ...
  function (
    ...
    $scope.relatedIdentifierAttribute = appService
      .getAppDescriptor()
      .getConfigValue("relatedIdentifierAttribute");
    $scope.today = Bahmni.Common.Util.DateTimeFormatter.getDateWithoutTime(
      dateUtil.now()
    );
    $scope.moduleName = appService
      .getAppDescriptor()
      .getConfigValue("registrationModuleName");
    var patientId;
    ...
    var prepopulateDefaultsInFields = function () {
      ...
      var isDateType = function (personAttributeType) {
        return (
          personAttributeType.format === "org.openmrs.util.AttributableDate"
        );
      };
      ...
      _.chain(defaultsWithAnswers)
        ...
        .value();
      if (
        $scope.relatedIdentifierAttribute &&
        $scope.relatedIdentifierAttribute.name
      ) {
