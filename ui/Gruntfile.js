...
module.exports = function (grunt) {
  ...
  var libraryCSSFiles = [
    ...
    "components/nepali-datepicker/nepali.datepicker.min.css",
  ...
  var libraryJSFiles = [
    ...
    "components/nepali-datepicker/nepali.datepicker.min.js",
  ...
  grunt.initConfig({
    ...
    preprocess: {
      ...
      multifile: {
        files: {
          "<%= yeoman.dist %>/registration.min.js":
            "<%= yeoman.dist %>/registration.min.js",
          "<%= yeoman.dist %>/admin.min.js": "<%= yeoman.dist %>/admin.min.js",
          "<%= yeoman.dist %>/adt.min.js": "<%= yeoman.dist %>/adt.min.js",
          "<%= yeoman.dist %>/bedmanagement.min.js":
            "<%= yeoman.dist %>/bedmanagement.min.js",
          "<%= yeoman.dist %>/document-upload.min.js":
            "<%= yeoman.dist %>/document-upload.min.js",
          "<%= yeoman.dist %>/home.min.js": "<%= yeoman.dist %>/home.min.js",
          "<%= yeoman.dist %>/orders.min.js":
            "<%= yeoman.dist %>/orders.min.js",
          "<%= yeoman.dist %>/reports.min.js":
            "<%= yeoman.dist %>/reports.min.js",
          "<%= yeoman.dist %>/clinical.min.js":
            "<%= yeoman.dist %>/clinical.min.js",
